...
# Telegram требует у сообщения, устанавливающего reply-клавиатуру, хоть
# какой-то текст, а удалить его нельзя (клавиатура пропадёт вместе с ним) —
# поэтому текст сведён к минимуму, а не объясняет, что происходит.
